...
(
    ...
    `space_id`    bigint(0)                                                     NULL DEFAULT NULL COMMENT '空间表id(代表此空间的定位)',
  ...
  COLLATE = utf8mb4_general_ci COMMENT = '设备表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '设备参数表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_device_arg
-- ----------------------------
...
(
    ...
    `update_date` bigint(0)                                                     NULL DEFAULT NULL,
    `update_user` bigint(0)                                                     NULL DEFAULT NULL,
    `device_id`   bigint(0)                                                     NULL DEFAULT NULL COMMENT '有回调的设备id',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '设备回调表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_device_callback
-- ----------------------------
...
(
    ...
    `update_date`               bigint(0)                                                     NULL DEFAULT NULL,
    `update_user`               bigint(0)                                                     NULL DEFAULT NULL,
    `passive_device_id`         bigint(0)                                                     NULL DEFAULT NULL COMMENT '被动方设备id',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '说明书表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `tigger_scene_id` bigint(0)                                                     NULL DEFAULT NULL COMMENT '触发场景id',
    `instructions_id` bigint(0)                                                     NULL DEFAULT NULL COMMENT '指令id',
    `manual`          int(0)                                                        NULL DEFAULT NULL COMMENT '1->人工设置\r\n2->网上批量导入\r\n3->机器自动学习',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '设备指令回应表'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `other_model_id` bigint(0)                                                     NULL DEFAULT NULL COMMENT '其他: 气氛 天气 动作等场景的模型id',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '场景表'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_scene
-- ----------------------------
