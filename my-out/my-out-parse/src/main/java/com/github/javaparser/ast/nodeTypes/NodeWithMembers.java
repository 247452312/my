...
public interface NodeWithMembers<N extends Node> extends NodeWithSimpleName<N> {
     ...
     * @param modifiers the modifiers like {@link Keyword#PUBLIC}
     *
     * @return the {@link FieldDeclaration} created
     */
    default FieldDeclaration addField(Class<?> typeClass, String name, Keyword... modifiers) {
     ...
     * @return the {@link FieldDeclaration} created
     */
    default FieldDeclaration addField(String type, String name, Keyword... modifiers) {
     ...
     * @return the {@link FieldDeclaration} created
     */
    default FieldDeclaration addField(Type type, String name, Keyword... modifiers) {
     ...
     * @return the {@link FieldDeclaration} created
     */
    default FieldDeclaration addFieldWithInitializer(Class<?> typeClass, String name, Expression initializer, Keyword... modifiers) {
        tryAddImportToParentCompilationUnit(typeClass);
     ...
     * @return the {@link FieldDeclaration} created
     */
    default FieldDeclaration addFieldWithInitializer(String type, String name, Expression initializer, Keyword... modifiers) {
