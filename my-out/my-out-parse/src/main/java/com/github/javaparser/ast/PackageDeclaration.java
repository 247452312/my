...
public class PackageDeclaration extends Node implements NodeWithAnnotations<PackageDeclaration>, NodeWithName<PackageDeclaration> {
    ...
    private List<CompilationUnit> otherCompilationUnits;
    ...
    public List<CompilationUnit> getOtherCompilationUnits() {
        return otherCompilationUnits;
    }

    public void setOtherCompilationUnits(List<CompilationUnit> otherCompilationUnits) {
