...
import indi.uhyils.protocol.rpc.provider.ServiceControlProvider;
...
@RpcService
@ReadWriteMark
public class ProviderControlProviderImpl implements ServiceControlProvider {
    ...
    public ServiceResult<Boolean> addOrEditMethodDisable(ObjRequest<AddOrEditMethodDisable> request) {
        ...
        try {
            ...
            if (StringUtils.isNotBlank(methodName)) {
                ...
                jedis.hset(MyContext.SERVICE_USEABLE_SWITCH, className, data.getType().toString());
            }
