 ...
 */
public class DetailTraceDeal extends AbstractTraceDeal<TraceDetailEntity> {

    @Override
    protected TraceDetailEntity getTargetEntity(String[] split) {
        if (split.length <= 7) {
        ...
        TraceDetailEntity entity = new TraceDetailEntity();
