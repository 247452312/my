...
import indi.uhyils.pojo.model.DeviceCallbackDO;
 ...
 */
@RpcService
public class DeviceCallbackServiceImpl extends BaseDefaultServiceImpl<DeviceCallbackDO> implements DeviceCallbackService {
    @Resource
