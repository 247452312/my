...
public class KproUtil {
    ...
    private static HashMap<String, String> getFileHashMapByTableInfos(HashMap<String, TableInfo> tableInfos, DbInformation dbInformation, String dateFormat, DbTypeEnum typeEnum) {
        ...
        for (Map.Entry<String, TableInfo> stringTableInfoEntry : tableInfos.entrySet()) {
            result.putAll(Objects.requireNonNull(
                createPojo(apiPath + "/src/main/java/indi/uhyils", KproStringUtil.dealDbNameToJavaFileName(stringTableInfoEntry.getKey()), stringTableInfoEntry.getValue(), dateFormat, typeEnum)));
            result.putAll(Objects.requireNonNull(
                createDao(servicePath + "/src/main/java/indi/uhyils", KproStringUtil.dealDbNameToJavaFileName(stringTableInfoEntry.getKey()), stringTableInfoEntry.getValue(), dateFormat, typeEnum)));
            result.putAll(Objects.requireNonNull(
            ...
            result.putAll(Objects.requireNonNull(
                createService(apiPath + "/src/main/java/indi/uhyils", KproStringUtil.dealDbNameToJavaFileName(stringTableInfoEntry.getKey()), stringTableInfoEntry.getValue(), dateFormat)));
            result.putAll(Objects.requireNonNull(
                createServiceImpl(servicePath + "/src/main/java/indi/uhyils", KproStringUtil.dealDbNameToJavaFileName(stringTableInfoEntry.getKey()), stringTableInfoEntry.getValue(), dateFormat)));
            result.putAll(Objects.requireNonNull(
    ...
    private static Map<String, String> createStartJvmParam(String servicePath, DbInformation dbInformation) {
        ...
        sb.append("-XX:+UseG1GC -XX:+PrintGCTimeStamps -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=d:/my/logs/").append(dbInformation.getSmallProjectName())
          .append("/JVM_DOWN.dump -Xms512m -Xmx512m -XX:NewRatio=1 -Xloggc:d:/my/logs/").append(dbInformation.getSmallProjectName()).append("/JVM.log ");
    ...
    private static Map<String, String> createDockerfile(String servicePath, DbInformation dbInformation) {
        ...
        sb.append(
          ...
          .append(dbInformation.getPort() + 50).append(" ").append(dbInformation.getPort() + 12850).append(
            "\n\n#应用构建成功后的jar文件被复制到镜像内，名字也改成了app.jar\nADD target/my-*.jar /app.jar\n\n#启动容器时的进程\nENTRYPOINT [\"java\",\"-Xms512m\",\"-Xmx512m\",\"-XX:+PrintGCTimeStamps\",\"-XX:+UseG1GC\",\"-XX:+HeapDumpOnOutOfMemoryError\",\"-XX:HeapDumpPath=/my/logs/")
          .append(dbInformation.getSmallProjectName()).append("/JVM_DOWN.dump\",\"-XX:NewRatio=1\",\"-Xloggc:/my/logs/").append(dbInformation.getSmallProjectName())
    ...
    private static HashMap<String, String> createMapper(String filepath, String className, TableInfo tableInfo, String dateFormat) {
        ...
        sb.append("<!DOCTYPE mapper PUBLIC \"-//mybatis.org//DTD Mapper 3.0//EN\" \"http://mybatis.org/dtd/mybatis-3-mapper.dtd\" >\n\n<mapper namespace=\"indi.uhyils.dao.").append(className)
          .append("Dao\">\n\n\n    <sql id=\"columnList\">\n");
        ...
        sb.append("\n    </sql>\n\n    <select id=\"getById\" resultType=\"indi.uhyils.pojo.model.").append(className)
    ...
    private static Map<String, String> createPojo(String filepath, String className, TableInfo tableInfo, String dateFormat, DbTypeEnum typeEnum) {
        ...
        sb.append("import indi.uhyils.pojo.model.base.BaseDoEntity;\n\n");
        sb.append("/**\n" +
                  " *\n" +
                  " * @author uhyils <247452312@qq.com>\n" +
                  " * @date 文件创建日期 " + dateFormat + "\n" +
