...
import indi.uhyils.util.mysql.pojo.response.impl.ResultSetResponse;
...
public class ComQueryRequest extends AbstractMysqlRequest {
    ...
    public ComQueryRequest(MysqlTcpInfo mysqlHandler, String sql) {
        super(mysqlHandler);
        this.sql = sql;
    }

    public ComQueryRequest(MysqlTcpInfo mysqlHandler) {
        super(mysqlHandler);
    }
