...
#
api_key="8e34a82bc684690f0131a03c4367689e1092196219" 			#api_key
api_token="c9b956635b8f119e6000877a28c763a0536723296" 	#api_token
url="http://192.168.1.101:4999/server/index.php?s=/api/open/fromComments" #同步到的url。使用www.showdoc.cc的不需要修改，使用开源版的请修改
#
#
#
#
