...
public class RpcNormalRequestContent extends AbstractRpcContent implements RpcRequestContent {
    ...
    public RpcNormalRequestContent(RpcData rpcData, String[] contentArray) throws ClassNotFoundException {
        super(contentArray);
        init();
        setRpcData(rpcData);
    }
    ...
    private void init() throws ClassNotFoundException {
        ...
        Class<?> serviceClass = Class.forName(this.getServiceName());
        ...
        try {
            Method method = serviceClass.getMethod(this.getMethodName(), methodParamterClass);
