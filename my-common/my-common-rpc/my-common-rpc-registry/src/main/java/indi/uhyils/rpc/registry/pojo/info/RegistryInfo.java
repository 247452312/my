...
public class RegistryInfo implements Serializable {
     ...
     * 注册时必要数据
     */
    private RegistryNecessaryInterface necessaryInfo;
    ...
    public RegistryNecessaryInterface getNecessaryInfo() {
        return necessaryInfo;
    }

    public void setNecessaryInfo(RegistryNecessaryInterface necessaryInfo) {
