...
public class RegistryModeFactory {
    ...
    public static RegistryMode create() throws InterruptedException {
        String registryModelName = (String) RpcConfigFactory.getCustomOrDefault(REGISTRY_MODE_SPI_NAME, DEFAULT_MODE_REGISTRY);
        return (RegistryMode) RpcSpiManager.createOrGetExtensionByClass(RegistryMode.class, registryModelName, null);
    }
}
